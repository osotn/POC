...
#define DATA_WRITE_CMD "python ./server/smarthome_data_update.py --addr %s" \
    " --write%s --file ./etc/data.xml"
#define CFG_VALUE2NAME_CMD  "python ./server/smarthome_cfg_parse.py --addr" \
    " %s%s --file ./etc/cfg.xml"
...
#define CFG_NAME2VALUE_CMD  "python ./server/smarthome_cfg_parse.py --device" \
    " %s --file ./etc/cfg.xml"
#define DATA_READ_CMD "python ./server/smarthome_data_update.py --addr %s" \
    " --file ./etc/data.xml"
